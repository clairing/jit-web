...
import { isVNode, isString } from '@/dev/utils/util'
...
const showMessage = (options: any) => {
  ...
  for (const prop in options) {
    if (Object.prototype.hasOwnProperty.call(options, prop) && !Object.prototype.hasOwnProperty.call(vm.$props, prop)) {
...
function MessageBox(
  ...
  return new Promise((resolve, reject) => {
    ...
    const ctx = messageInstance.set(vm, {
      options,
      callback,
      resolve,
      reject,
